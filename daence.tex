...
%
\begin{description}
  \item[\normalfont $c = \DaenceEncrypt(k, a, m)$] takes
  ...
  \item[\normalfont $m' = \DaenceDecrypt(k, a', c')$] takes a key $k$,
     a string $a'$ of at most $2^{38}$ bytes of associated data, and an
     alleged authenticated ciphertext $c'$ of at most $24 + 2^{38}$
     bytes.
