...
For each user, let $F(n) \in \{0,1\}^{512}$ be an independent uniform
 random key derivation function for the nonce $n$, which will be used
 to generate $(k_0, k_1, k_2)$ for $\DAENCE/_1$.
