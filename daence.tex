...
Rather than hash the associated data separately, implementations of
 ...
 implemented in \libsodium/ \sodiumaead/ support passing multiple
 strings into \Poly1305/ natively, with a 4-byte little-endian length
 $\lvert a\rvert_4$ appended:
%
\begin{itemize}
  ...
  \item $t \concat \_ :=
      \HXChaCha/_{k_0}(
        \Poly1305/^2_{k_1,k_2}(a \concat m \concat \lvert a\rvert_4))$
    \hfill (24-byte $t$)
