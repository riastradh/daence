...

\newcommand{\todo}[1]{\ifdraft{\textbf{\textcolor{red}{#1}}}{}}
\newcommand{\warning}[1]{\todo{\textsc{Warning}: #1}}
...
\begin{abstract}
  ...
  We recommend instantiation using
...
\begin{description}
  ...
  \item[Why not use \Auth256/?]
    ...
    With \DAENCE/, even if messages were the maximum length, $2^{33}$
     ...
     of a \emph{single} forgery would remain below $2^{-32}$.
    \todo{Double-check this bound!}
    So there is little \emph{security} motivation to replace
     \Poly1305/ by a larger universal hash family.
