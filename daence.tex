...
\begin{enumerate}
  ...
  \item If you choose a distinct associated data string for every
     ...
     authenticated ciphertexts of your messages from uniform random
     byte strings of the same length.
...
\]
 a 32-byte string.
Note \HXSalsa20/ can be defined in terms of \XSalsa20/ by choosing the
 appropriate words of the output and subtracting $j$, just as
 \HSalsa20/ can be defined in terms of \Salsa20/, and has comparable
 security~\cite{bernstein2011xsalsa}.
